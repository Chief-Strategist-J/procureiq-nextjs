...
export function useAuthManagement() {
  ...
  const signupForm = useAppSelector((state) => state.auth.signupForm ?? { name: '', email: '', password: '', showPassword: false, companyName: '', role: 'user', agreeToTerms: false, roleMetadata: {} });
