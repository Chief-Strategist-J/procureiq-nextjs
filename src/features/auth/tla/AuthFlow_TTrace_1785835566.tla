---- MODULE AuthFlow_TTrace_1785835566 ----
...
_inv ==
    ~(
        ...
        /\
        tokenOwnerMap = ((at1 :> "none" @@ at2 :> "none" @@ rt1 :> "none" @@ rt2 :> "none"))
        /\
        ...
        /\
        tokenSessionMap = ((at1 :> "none" @@ at2 :> "none"))
        /\
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("AuthFlow_TTrace_1785835566.json", _TETrace)
...
\*
\*trace == IODeserialize("AuthFlow_TTrace_1785835566.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG AuthFlow_TTrace_1785835566 ----
CONSTANTS
    Users = { user1 , user2 }
...
ALIAS
    _expression
=============================================================================
\* Generated on Tue Aug 04 14:56:09 IST 2026